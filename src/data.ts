...
export const NAVIGATION_TABS: NavigationTab[] = [
  ...
  { id: 'lebanon', labelAr: 'أخبار وقضايا لبنان والشرق الأدنى', labelEn: 'Lebanon & Near East News' },
  ...
  { id: 'intelligence-dispatch', labelAr: 'البرقية الاستخباراتية اليومية (الإصدار الحي)', labelEn: 'Current Daily Intelligence Dispatch' },
