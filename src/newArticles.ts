...
The current equation is stark: either return to a realistic negotiation path that acknowledges regional balances of power, or slide into a total economic and security collapse for the Middle East, from which no victor will emerge.`
  },
  {
    ...
    focusKeyword: 'زيارة-جوزيف-عون-البيت-الأبيض-واشنطن',
    category: 'lebanon',
    categories: ['lebanon', 'exclusives', 'middle-east', 'urgent-release'],
    titleAr: 'القمة التاريخية في البيت الأبيض: رفع حظر الطيران المباشر، دعم الجيش، واستحقاقات السيادة اللبنانية',
    titleEn: "Historic Oval Office Summit: Direct US-Lebanon Flights Resumed, Army Support & Sovereignty Challenges",
    summaryAr: 'تفاصيل القمة التاريخية بين الرئيس اللبناني جوزيف عون والرئيس الأمريكي دونالد ترامب في المكتب البيضاوي: إعلان رفع حظر الرحلات الجوية المباشرة (TRUMP SAYS YES) المفروض منذ 1985، تعهد واشنطن بدعم الجيش، والمواقف الداخلية بين التأييد والمعارضة.',
    summaryEn: "Full breakdown of President Joseph Aoun's historic meeting with Donald Trump in the Oval Office: Announcement of direct US-Lebanon flight resumption after 41 years, military backing, and internal Lebanese reactions.",
    excerptAr: 'تغطية شاملة لنتائج زيارة الرئيس جوزيف عون التاريخية للبيت الأبيض: رفع حظر الطيران المباشر، ملف نزع السلاح والانسحاب الإسرائيلي، والجدول الكامل للتحديات القادمة أمام العهد.',
    excerptEn: "Comprehensive coverage of President Joseph Aoun's landmark White House summit with Donald Trump: Direct flights restored, Hezbollah disarmament demands, and the matrix of upcoming sovereign challenges.",
    author: {
    ...
    isPremium: true,
    views: 58900,
    tags: ['جوزيف_عون', 'ترامب', 'البيت_الأبيض', 'رحلات_مباشرة', 'الجيش_اللبناني', 'حظر_الطيران', 'Joseph_Aoun', 'Trump', 'White_House', 'Direct_Flights', 'Lebanese_Army'],
    hashtags: ['JosephAoun', 'TrumpLebanon', 'DirectFlightsBeirut', 'LebaneseSovereignty'],
    contentAr: `### زيارة رئيس الجمهورية جوزيف عون التاريخية إلى واشنطن: القمة الإقليمية وتداعيات رفع حظر الطيران المباشر

---

### ١. القمة التاريخية في البيت الأبيض: تفاصيل الزيارة واللقاء

في زيارة تُعد الأولى لـ رئيس لبناني إلى البيت الأبيض منذ سنوات طويلة، التقى الرئيس اللبناني **جوزيف عون** بالرئيس الأمريكي **دونالد ترامب** في المكتب البيضاوي. جاءت الزيارة في خضم ظروف إقليمية ودولية معقدة، تخللتها مفاوضات برعاية واشنطن لترتيب الأوضاع على الحدود الجنوبية ومحاولة إنهاء حالة الصراع مع إسرائيل.

خلال اللقاء، أعرب الرئيس ترامب عن تعاطفه الكبير مع لبنان، مشيراً إلى أن هذا البلد **"تعرض لمعاملة سيئة للغاية على مدى عقود"**، ووعد بتقديم دعم كبير للجيش اللبناني والدولة اللبنانية. ومن جانبه، أشاد الرئيس عون برؤية ترامب لتحقيق السلام في المنطقة، مؤكداً أن **الجيش اللبناني هو العمود الفقري للاستقرار**.

---

### ٢. المفاجأة الكبرى: استئناف الرحلات الجوية المباشرة (TRUMP SAYS YES)

في خطوة إيجابية وغير متوقعة عقبت الاجتماع مباشرة، أعلن الرئيس ترامب عبر منصته **Truth Social** عن **رفع الحظر عن الرحلات الجوية المباشرة بين الولايات المتحدة ولبنان**، وهو الحظر الذي كان فرضاً أمريكياً منذ عام 1985 (منذ عهد الرئيس رونالد ريغان إثر حادثة اختطاف طائرة TWA 847).

* **مضمون القرار:** توجيه الإدارة الأمريكية للسماح لجميع شركات الطيران الأمريكية بتنظيم رحلات مباشرة إلى بيروت.
* **الأهمية الاقتصاديّة والسياسية:** يُعتبر هذا القرار بمثابة شهادة ثقة أمنية وسياسية بالدولة اللبنانية ومطار رفيق الحريري الدولي، وسيسهل حركة الاغتراب اللبناني الضخم في أمريكا الشمالية، ويُنعش حركة السياحة والاستثمار المباشر.

---

### ٣. المؤتمر الصحفي والملفات المطروحة

خلال التصريحات والمؤتمر الصحفي الذي رافق الزيارة، تم تركيز الضوء على النقاط المفصلية التالية:

* **نزع سلاح "حزب الله" واستعادة السيادة:** أكدت واشنطن دعمها الكامل لخطة انتشار الجيش اللبناني في الجنوب وبسط سلطة الدولة وحدها. وأشار ترامب إلى وجود **"خطط ملموسة"** لمساعدة الجيش ليصبح أكثر قدرة واعتماداً على ذاته.
* **الانسحاب الإسرائيلي:** طالب الرئيس عون بضغط أمريكي حقيقي لإلزام إسرائيل بالانسحاب الكامل من الأراضي التي احتلتها مؤخراً في الجنوب لتطبيق الاتفاقات الحدودية.
* **الدعم العسكري:** شُدد على ضرورة مواصلة دعم الجيش اللبناني بالعتاد والتمويل والتكنولوجيا لضمان عدم حدوث أي فراغ أمني في المناطق الحدودية.

---

### ٤. التحديات التي تواجه الرئيس عون: هل تُقبل في لبنان أم ترفض؟

تضع نتائج هذه الزيارة الرئيس عون أمام مشهد داخلي معقد ومقسم حول كيفية التعامل مع الالتزامات والتفاهمات الدولية:

#### أ. القبول والتأييد (المخيم المؤيد)
* **الأحزاب السياسية السيادية والقوى التغييرية:** ترى في هذه الخطوة عودة حقيقية لسيادة الدولة وحصر السلاح بيد المؤسسة العسكرية، وتعتبر استئناف الرحلات الجوية ودعم واشنطن مكسباً اقتصادياً وسياسياً كبيراً.
* **الشارع الاقتصادي والشعبي:** يرحب الشارع بالانفتاح الأمريكي لما له من أثر إيجابي على ليرة لبنان وتدفّق الاستثمارات وسهولة تنقل المغتربين.

#### ب. الرفض والتحفظ (المخيم المعارض)
* **حزب الله وحلفاؤه:** يرفضون أي طرح يتعلق بنزع السلاح أو تقييد دور "المقاومة"، ويعتبرون الشروط الأمريكية والإسرائيلية مساساً بالسيادة الوطنية وشكلاً من أشكال الضغط السياسي.
* **التشكيك في النوايا الإسرائيلية:** يرى المعارضون أن التعهّدات الأمريكية لن تُبطل الخروقات الإسرائيلية المستمرة، وأن الاعتماد على واشنطن وحدها قد يضعف موقف لبنان التفاوضي.

---

### ٥. التحديات القادمة أمام العهد اللبناني

أمام رئيس الجمهورية والحكومة اللبنانية حقل ألغام سياسي وأمني يجب التعامل معه بحذر:

| نوع التحدي | أبعاد التحدي والخطورة |
| :--- | :--- |
| **التحدي الأمني والسيادي** | ضمان عدم الاشتباك الداخلي أثناء انتشار الجيش في الجنوب، والتعامل مع سلاح حزب الله دون الانزلاق إلى فتنة داخلية. |
| **التحدي التفاوضي مع إسرائيل** | إلزام الجانب الإسرائيلي بالانسحاب الكامل ووقف الخروقات الجوية والبرية، خاصة مع استمرار التوتر على الحدود. |
| **التحدي الاقتصادي والمالي** | تنفيذ الإصلاحات الهيكلية التي يطالب بها المجتمع الدولي وصندوق النقد للاستفادة من الدعم الأمريكي والأوروبي. |
| **التوازن الإقليمي** | إدارة العلاقات مع المحور الإيراني-البرلماني في ظل التصعيد الإقليمي، والحفاظ على الحياد الإيجابي للبنان. |

---

### الخلاصة:

تشكل زيارة الرئيس جوزيف عون إلى واشنطن وفرض قرار استئناف الرحلات المباشرة نقطة تحول حقيقية في العلاقات اللبنانية-الأمريكية. إلا أن نجاح هذا الانفتاح رهين بقدرة العهد على إدارة التوازنات الداخلية المعقدة وتطبيق التفاهمات دون إشعال انقسام داخلي خطير.`,
    contentEn: `### President Joseph Aoun’s Historic Summit in Washington: Direct Flights Resumed & Sovereign Challenges

---

### 1. The Historic White House Summit: Oval Office Details

In a landmark visit marking the first official trip by a Lebanese president to the White House in years, Lebanese President **Joseph Aoun** met with US President **Donald Trump** in the Oval Office. The summit unfolded amidst complex regional and international dynamics, featuring US-brokered talks aimed at stabilizing the southern border and halting ongoing conflict with Israel.

During the meeting, President Trump expressed deep empathy for Lebanon, remarking that the nation had been **"treated very badly over many decades,"** while pledging substantial military and financial support for the Lebanese Armed Forces (LAF) and state institutions. For his part, President Aoun praised Trump's vision for regional peace, reaffirming that **the Lebanese Army is the ultimate backbone of national stability**.

---

### 2. The Major Surprise: Direct Flights Resumed (TRUMP SAYS YES)

In an unexpected and major breakthrough following the Oval Office meeting, President Trump announced via **Truth Social** the **lifting of the ban on direct commercial flights between the United States and Lebanon**. This ban had been in place since 1985 (enforced under President Ronald Reagan following the hijacking of TWA Flight 847).

* **Decision Substance:** Directing US authorities to permit American and Lebanese air carriers to operate direct flights between North America and Beirut’s Rafic Hariri International Airport.
* **Economic & Political Impact:** Serving as a significant vote of security and political confidence in the Lebanese state, this move facilitates travel for the vast Lebanese diaspora across North America while breathing new life into tourism, trade, and direct investment.

---

### 3. Press Conference & Core Files Raised

During joint press statements and meetings following the summit, discussions centered on the following key issues:

* **Disarming Hezbollah & Restoring Sovereignty:** Washington reiterated full backing for the deployment of the Lebanese Army throughout the south to establish exclusive state authority. Trump highlighted the existence of **"concrete plans"** to empower the LAF toward self-reliance.
* **Israeli Withdrawal:** President Aoun called for genuine US pressure to compel Israel to execute a complete withdrawal from recently occupied southern territories and comply with border agreements.
* **Military Support:** Emphasizing continuous supply of equipment, funding, and defense technology to ensure no security vacuum arises along the border.

---

### 4. Domestic Challenges for President Aoun: Acceptance vs. Rejection

The outcomes of the visit place President Aoun before a complex and deeply polarized domestic political landscape regarding international commitments:

#### A. Acceptance & Endorsement (Pro-Sovereignty Camp)
* **Sovereign Parties & Reformist Movements:** View the summit as a pivotal step toward restoring state authority and restricting weapons exclusively to the military, hailing the resumption of direct flights as a massive economic win.
* **Economic & Popular Sphere:** Welcomes the US opening for its immediate positive impact on the Lebanese Pound, investment inflows, and diaspora connectivity.

#### B. Rejection & Reservations (Opposition Camp)
* **Hezbollah & Allies:** Reject any framework demanding disarmament or restricting "resistance" operations, interpreting US and Israeli stipulations as political coercion violating national sovereignty.
* **Skepticism Over Israeli Intentions:** Opponents argue that US promises will not halt ongoing Israeli incursions, warning that relying solely on Washington weakens Lebanon's negotiating stance.

---

### 5. Upcoming Challenges Facing the Lebanese Administration

President Aoun and the Lebanese government face a high-stakes political and security minefield that requires delicate management:

| Challenge Type | Dimensions & Strategic Risks |
| :--- | :--- |
| **Security & Sovereign Challenge** | Preventing internal clashes during southern army deployment while addressing Hezbollah's arsenal without triggering civil unrest. |
| **Negotiations with Israel** | Compelling full Israeli withdrawal and an end to air and ground violations amid volatile border conditions. |
| **Economic & Financial Challenge** | Implementing structural IMF reforms required to unlock US, European, and international financial packages. |
| **Regional Balance** | Managing relations with the Iran-aligned axis during regional escalation while preserving Lebanon's positive neutrality. |

---

### Conclusion:

President Joseph Aoun's summit in Washington and the sudden resumption of direct flights mark a genuine turning point in US-Lebanon relations. However, the ultimate success of this opening hinges on the administration's ability to navigate delicate domestic balances without sparking a dangerous internal rift.`
  },
  {
...
* **Sustained Highs (July 2026):** Despite a 2% drop in global Brent crude, local gasoline stabilized at 2,220,000 LBP, embedding the tax burden permanently into the daily cost of living.`,
  ...
  },
  {
    ...
    summaryAr: `تشريح استقصائي شامل لقاعدة الودائع اللبنانية البالغة ٨٩.٤ مليار دولار حتى مايو ٢٠٢٦. يحلل التقرير مسار التآكل الصامت البالغ ٢.٨ مليار دولار سنوياً ومطالبات المودعين المحتجزين في مواجهة السيولة والذهب البالغ ٤١.٧ مليار دولار.`,
    summaryEn: `An intensive investigative dissection of the $89.4 Billion Lebanese bank deposits up to May 2026. The report analyzes the $2.8B annual silent attrition, asset mismatches, and the critical role of $41.7 Billion sovereign gold reserves.`,
    excerptAr: 'تحقيق مالي معزز بالرسوم التفاعلية يكشف مصير ٨٩.٤ مليار دولار من الودائع المحتجزة وخريطة تسييل الأصول والذهب لإنقاذ أموال المودعين اللبنانيين.',
    excerptEn: 'Data-driven autopsy of the $89.4B Lebanese trapped deposits, analyzing cash reserves, gold, and future recovery scenarios.',
    contentAr: `### لبنان — الودائع: تحليل موجز ومحاكاة مستقبلية
**القطاع المصرفي | فبراير ٢٠٢٤ – مايو ٢٠٢٦**

---

### ١. المسار خلال ٢٨ شهراً
تقلّصت قاعدة الودائع بمقدار ٥.٥ مليار دولار في ٢٨ شهراً — أي نحو ٢.٤ مليار دولار سنوياً. يعكس هذا المنحنى التنازلي استنزافاً هادئاً ومنظماً للخصوم المصرفية دون تعافٍ حقيقي.

* **فبراير ٢٠٢٤ (البداية):** ٨,٤٨٨,٦٥٢,٤٢٥ مليون ل.ل. (ما يعادل ٩٤.٨ مليار دولار)
* **مايو ٢٠٢٤:** ٨,٤٩٨,٣٤٧,٩٠٧ مليون ل.ل. (ما يعادل ٩٤.٩ مليار دولار) | تغيير شهري: +٠.١١٪
* **سبتمبر ٢٠٢٤:** ٨,٣٥٥,٩٥١,٧٣٠ مليون ل.ل. (ما يعادل ٩٣.٤ مليار دولار) | تغيير شهري: -١.٦٨٪
* **ديسمبر ٢٠٢٤:** ٨,٢٥٩,٩٨٩,٣١٧ مليون ل.ل. (ما يعادل ٩٢.٣ مليار دولار) | تغيير شهري: -١.١٤٪
* **يونيو ٢٠٢٥:** ٨,٢٧٥,٣٧٨,٢٩٩ مليون ل.ل. (ما يعادل ٩٢.٥ مليار دولار) | تغيير شهري: مستقر
* **ديسمبر ٢٠٢٥:** ٨,١١٩,٤٦٦,٩٥٥ مليون ل.ل. (ما يعادل ٩٠.٧ مليار دولار) | تغيير شهري: -١.٨٨٪
* **مايو ٢٠٢٦ (الأحدث):** ٧,٩٩٧,٩٣٥,١٢٣ مليون ل.ل. (ما يعادل ٨٩.٤ مليار دولار) | تغيير شهري: -٠.٢١٪

---

### ٢. التفصيل حسب ثلاثة مكوّنات (مايو ٢٠٢٦)
تتركز المطالبات الإجمالية بشكل ساحق في ودائع العملاء التجاريين، مما يجعل أزمة المودعين قضية اجتماعية واقتصادية تهم ملايين الأسر والشركات:

* **ودائع العملاء:** ٧,٦٦٢,٩٠٥,٧٧٤ مليون ل.ل. (ما يعادل ٨٥.٦ مليار دولار) | الحصة: ٩٥.٨٪
* **ودائع القطاع المالي:** ٢٧٧,٢٨٥,٨٤٦ مليون ل.ل. (ما يعادل ٣.١ مليار دولار) | الحصة: ٣.٥٪
* **ودائع القطاع العام:** ٥٧,٧٤٣,٥٠٣ مليون ل.ل. (ما يعادل ٠.٦٥ مليار دولار) | الحصة: ٠.٧٪
* **الإجمالي الكلي:** ٧,٩٩٧,٩٣٥,١٢٣ مليون ل.ل. (ما يعادل ٨٩.٤ مليار دولار)

---

### ٣. التوزيع بحسب العملة — ودائع العملاء
يكشف تفكيك العملات عن تآكل حاد في ودائع المقيمين بالعملات الأجنبية، وهي الودائع المحتجزة تاريخياً:

* **المقيمون بالليرة:** ٤٧,٦٧٠,٥٤٠ مليون ل.ل. (فبراير ٢٤) ➜ ٧٤,٧٨٥,٤٨٣ مليون ل.ل. (مايو ٢٦) | تغيير: +٥٦.٩٪
* **المقيمون بالعملات الأجنبية:** ٦,١٧٤,٧٨٩,٤٧٧ مليون ل.ل. (فبراير ٢٤) ➜ ٥,٦٧٤,٣١٢,٩٣٧ مليون ل.ل. (مايو ٢٦) | تغيير: -٨.١٪ (خسارة ٥.٦ مليار دولار فعلياً)
* **غير المقيمين (المغتربين):** ١,٨٨٤,٤٧٧,٩٤٥ مليون ل.ل. (فبراير ٢٤) ➜ ١,٩١٣,٨٠٧,٣٥٤ مليون ل.ل. (مايو ٢٦) | تغيير: +١.٦٪ (صمود لافت)

---

### ٤. أربع ملاحظات جوهرية

#### ① ودائع المقيمين بالعملات الأجنبية — الشريان النازف
تراجعت هذه الودائع بخسارة تبلغ ٥٠٠.٥ تريليون ليرة (-٨.١٪) ما يعادل نحو ٥.٦ مليار دولار. هذه هي قاعدة المودعين المحتجزين تخرج تدريجياً عبر القنوات غير الرسمية وتسويات الديون وآليات التعاميم المالية بخصومات قاسية (Lollar Haircuts).

#### ② ودائع غير المقيمين — صمود لافت
ودائع الاغتراب ارتفعت فعلياً بنسبة +١.٦٪ خلال ٢٨ شهراً (+٣٣٠ مليون دولار). يعكس ذلك استمرار تدفقات المغتربين اللبنانيين وتمسكهم بحساباتهم وعدم انسحابهم التام رغم الأزمة الهيكلية.

#### ③ الودائع بالليرة — نمو اسمي بلا مضمون حقيقي
قفزت ودائع الليرة +٥٧٪ اسمياً (إلى ٧٤.٨ تريليون ليرة). لكن بالدولار الفعلي وعلى سعر ٨٩,٥٠٠ لا تساوي سوى ٨٣٥ مليون دولار. هذا النمو يعكس رواتب ومعاملات يومية بسيطة وتآكلاً في القوة الشرائية الحقيقية.

#### ④ ودائع القطاع العام — الحكومة تسحب أرصدتها
تراجعت ودائع القطاع العام في البنوك التجارية بنسبة -٧.٨٪، حيث سحبت أرصدتها وأودعتها في مصرف لبنان (حيث بلغت ودائع القطاع العام في مصرف لبنان ٨٦٠.٧ تريليون ليرة = ٩.٦ مليار دولار في مايو ٢٠٢٦)، مما يجرّد المصارف من السيولة.

---

### ٥. الدولرة الهيكلية
بلغت نسبة دولرة الودائع ٩٨.٧١٪ في مايو ٢٠٢٦. هذا التثبيت المطلق يعني أن تصفية الأزمة يستلزم دولارات حقيقية بالكامل، ولا تملك الليرة أي قدرة تضخمية لإذابة هذه الالتزامات.

---

### ٦. التوقعات بالوتيرة الراهنة
* **متوسط الانخفاض الشهري:** ~١٩٦ مليون دولار شهرياً
* **الوتيرة السنوية:** ~٢.٤ مليار دولار/سنة
* **إجمالي الودائع المتوقع - مايو ٢٠٢٧:** ~٨٧.٠ مليار دولار
* **إجمالي الودائع المتوقع - مايو ٢٠٣٠:** ~٧٩.٨ مليار دولار

---

### الخلاصة الرقمية للواقع
* **الودائع الكلية المطالب بها:** ٨٩.٤ مليار دولار
* **إجمالي الأصول المتاحة للتوزيع فوراً (دون الذهب):** ٢٠.٩ مليار دولار (عجز بقيمة ٦٨.٥ مليار دولار)
* **مع تسييل الذهب البالغ ٤١.٧ مليار دولار:** يرتفع المغطى إلى ٦٢.٦ مليار دولار (عجز بقيمة ٢٦.٨ مليار دولار)

مصير قاعدة الودائع مرهون بقرار البرلمان التاريخي بتسييل أو رهن الاحتياطي الذهبي المجمّد بموجب القانون ٤٢/٨٦. وكل سنة تأخير تلتهم ٢.٨ مليار دولار من حقوق المودعين بصمت عبر آليات الاقتطاع غير الرسمية.`,
    contentEn: `### Lebanon — The Trap of trapped Bank Deposits
**Monetary Analysis | February 2024 – May 2026**

---

### 1. The 28-Month Trend Line
The total base of deposits shrank by $5.5 Billion over 28 months—averaging roughly $2.4 Billion in silent erosion annually.

* **February 2024 (Baseline):** 8,488,652,425M LBP (~$94.8 Billion)
* **May 2024:** 8,498,347,907M LBP (~$94.9 Billion) | +0.11%
* **September 2024:** 8,355,951,730M LBP (~$93.4 Billion) | -1.68%
* **December 2024:** 8,259,989,317M LBP (~$92.3 Billion) | -1.14%
* **June 2025:** 8,275,378,299M LBP (~$92.5 Billion) | Stable
* **December 2025:** 8,119,466,955M LBP (~$90.7 Billion) | -1.88%
* **May 2026 (Latest):** 7,997,935,123M LBP (~$89.4 Billion) | -0.21%

---

### 2. Segment Analysis (May 2026)
* **Customer Deposits:** 7,662,905,774M LBP (~$85.6 Billion) | Share: 95.8%
* **Financial Sector Deposits:** 277,285,846M LBP (~$3.1 Billion) | Share: 3.5%
* **Public Sector Deposits:** 57,743,503M LBP (~$0.65 Billion) | Share: 0.7%
* **Grand Total:** 7,997,935,123M LBP (~$89.4 Billion)

---

### 3. Currency Distribution — Customer Accounts
* **Residents in LBP:** 47.7T LBP (Feb 24) ➜ 74.8T LBP (May 26) | +56.9%
* **Residents in Foreign Currency:** 6,174.8T LBP (Feb 24) ➜ 5,674.3T LBP (May 26) | -8.1% (Loss of ~$5.6B USD)
* **Non-Residents (Diaspora):** 1,884.5T LBP (Feb 24) ➜ 1,913.8T LBP (May 26) | +1.6%

---

### 4. Four Core Observations
1. **The Trapped USD Bleed:** Resident foreign currency balances plummeted by -8.1% (a $5.6B loss). These accounts exit via shadow haircuts, credit-swapping, and non-official parallel rate cash-outs.
2. **Diaspora Resilience:** Non-resident deposits rose by +1.6% (+$330M), highlighting the continued commitment of expatriates to maintain accounts despite sovereign distress.
3. **LBP Nominal Growth:** LBP accounts surged 57% nominally to 74.8T LBP, yet represent a mere $835M at the current 89,500 exchange rate.
4. **Public Capital Exodus:** Public sector entities withdrew balances from commercial banks to BdL, where treasury cash reached 860.7T LBP ($9.6B) in May 2026.

---

### 5. Final Balance Sheet Calculations
* **Total Liabilities:** $89.4 Billion
* **Covered Liquid Assets (No Gold):** $20.9 Billion (Unfunded Gap: $68.5 Billion)
* **Covered Assets with Gold ($41.7B):** $62.6 Billion (Unfunded Gap: $26.8 Billion)

Excluding Gold reserves, protected under Law 42/86, trapped depositors face a recovery rate of only 23 cents on the dollar. Unlocking Gold could boost overall recovery yields to ~70%.`,
    author: {
      nameAr: 'معن البرازي',
      nameEn: 'Maan Barazy',
      titleAr: 'كبير الباحثين الماليين',
    ...
    isFeatured: true,
    isPremium: true,
    tags: ['الودائع_اللبنانية', 'تسييل_الذهب', 'أزمة_البنوك', 'صندوق_التعافي', 'Lebanese_Deposits_2026', 'Gold_Reserves', 'Monetary_Gap'],
    excerpt: 'A comprehensive visual and interactive data breakdown of the Lebanese trapped bank deposits worth $89.4B.',
    hashtags: ['Lebanese_Deposits_2026', 'Gold_Reserves', 'Monetary_Gap'],
    views: 6120
  },
  {
    id: 'submarine-cables-geopolitics-2026',
    category: 'exclusives',
    categories: ['exclusives', 'translations', 'lebanon', 'telecom-internet'],
    ...
    summaryAr: `ترجمة استقصائية مشتركة لتقريري الإيكونوميست وتشاتام هاوس حول عسكرة الإنترنت العالمي. كيف بدأت طفرة الذكاء الاصطناعي وحرب المسيرات الإيرانية بإعادة رسم خرائط جغرافيا الاتصالات وتأمين ممرات البيانات السفلية في المحيط الهندي والبحر الأحمر.`,
    summaryEn: `Joint investigative translations of landmark analyses from The Economist and Chatham House regarding global internet militarization. Details how the AI boom, US-China rivalry, and Iranian drone strikes reshape subsea fiber routes and digital security frameworks.`,
    excerptAr: 'تحقيق استقصائي ومستند ترجمة كاملة لتقرير الإيكونوميست وتشاتام هاوس حول الكابلات البحرية المعزز بالإنفوجرافيك المدمج من غوام إلى هرمز وعمان.',
    excerptEn: 'Deep translation and infographic autopsy of global internet pipelines under threat from the South China Sea to the Red Sea and Hormuz.',
    contentAr: `### البنية التحتية الرقمية تحت التهديد: الكابلات البحرية ومراكز البيانات
**دراسات وترجمات حرة | الإيكونوميست & تشاتام هاوس (٢٠٢٦)**

---

### أولاً: تقرير الإيكونوميست — دور الجيوبوليتيك والذكاء الاصطناعي في إعادة رسم خريطة الكابلات

تكمن أهمية التقرير في أنه يربط بين تطورين يجري التعامل معهما منفصلين: سباق بناء مراكز بيانات الذكاء الاصطناعي، وإعادة رسم الخريطة الجغرافية للبنية التحتية الرقمية العالمية.

#### ١. طفرة الذكاء الاصطناعي تغير المسارات
بدلاً من تصميم الكابلات لربط المدن السكانية الكبرى، باتت تُبنى بصورة متزايدة لربط مراكز البيانات العملاقة التابعة لشركات السحاب والذكاء الاصطناعي. تتدفق البيانات السحابية الضخمة بين مخازن الخوادم لا بين المشتركين فحسب.

#### ٢. تجنب مياه النفوذ الصيني والمضائق الضيقة
تتجنب الشركات الأمريكية (غوغل وميتا ومايكروسوفت) مضيق ملقا وبحر الصين الجنوبي هرباً من النفوذ الصيني. فقوانين بكين تشترط إذناً معقداً لأي عملية صيانة داخل "خط النقاط التسع" الصيني.
لذا، نشأ مسار بديل يسير من **سلطنة عُمان** إلى **أستراليا** ثم عبر المحيط الهادئ نحو **الولايات المتحدة**.

#### ٣. مشاريع تترجم الواقع
* **كابل عُمان-أستراليا (٢٠٢٢):** يشمل وصلات لقاعدة دييغو غارسيا العسكرية الأمريكية البريطانية وجزر كوكوس الأسترالية.
* **مشروع غوغل:** يحول جزيرة كريسماس الأسترالية إلى عقدة رئيسية تربط الشرق الأوسط بأستراليا.
* **مشروع Waterworth التابع لشركة ميتا:** يسلك المسار نفسه لتفادي جنوب شرق آسيا.

---

### ثانياً: تقرير تشاتام هاوس — حرب الظل الإيرانية وعسكرة الإنترنت

#### ١. هجوم المسيرات على مراكز بيانات AWS
ينطلق التقرير من حادثة استهداف طائرات مسيرة إيرانية لمراكز بيانات أمازون في الإمارات والبحرين، كاشفة عن غياب جهة دولية مسؤولة عن حماية الإنترنت العالمي.
تسبب الهجوم في تعطيل خدمات الدفع الإلكتروني (Alaan, Hubpay) وتوقف Careem لبعض الوقت وتعطل مواقع بنكية.

#### ٢. البحر الأحمر وهرمز: شرايين معطّلة
* **البحر الأحمر:** يحمل ١٧٪ من الإنترنت العالمي و٩٠٪ من كابلات الاتصال بين آسيا وأوروبا.
* **مضيق هرمز:** تخدمه ٤ كابلات رئيسية تربط الكويت والقطر والإمارات بالعالم.
إغلاق المسارين معاً أو استهداف كابلاتهما يهدد الكوكب بكارثة رقمية تامة. وتزيد المشكلة بسبب عجز سفن صيانة e-Marine من العمل بأمان في البحر الأحمر الملتهب.

#### ٣. غياب الإطار القانوني
أقدم الاتفاقيات لحماية الكابلات تعود لعام ١٨٨٤ واتفاقية البحار ١٩٩٤ لا تخدم النزاعات المسلحة، وتجعل الشركات التجارية عاجزة عن ملاحقة الدول قضائياً. هذا دفع غوغل وميتا للمطالبة بضمانات عسكرية أمريكية وحماية أمنية مباشرة لمنشآتهم.`,
    contentEn: `### Digital Infrastructure Under Threat: Undersea Cables & Geopolitics
**Investigative Translations | The Economist & Chatham House Reports (2026)**

---

### I. The Economist Report: AI Boom and Geopolitical Realignment
Subsea fiber routes are shifting from linking population centers to wiring high-density AI data center hubs.

#### 1. Strategic Redirection
US technology giants (Google, Meta, Microsoft, Amazon) increasingly avoid Chinese-controlled waters in the South China Sea. Inside Chinas "Nine-Dash Line," state permissions for cable laying and ship repairs present systemic risks.

#### 2. The Oman-Australia Highway
A new digital highway is built from **Oman** to **Australia**, and across the Pacific to the **United States**. Key projects include:
* **Oman-Australia Cable (2022):** Hooks directly into the strategic US-UK military base at Diego Garcia.
* **Google's Christmas Island Hub:** Converts the remote Australian territory into a core routing gateway.
* **Meta's Waterworth Project:** Follows the same deep Indian Ocean trench to bypass Southeast Asian choke points.

---

### II. Chatham House Report: The Shadow Warfare Matrix
Physical infrastructure is incredibly fragile in active warzones.

#### 1. The AWS Drone Attacks
Drone strikes on Amazon Web Services (AWS) centers in Bahrain and the UAE immediately disrupted localization layers (Careem, Alaan, Hubpay, bank portals), proving how fast daily civil life collapses when physical servers are targets.

#### 2. Red Sea and Hormuz Choke Points
The Red Sea handles 17% of total global web routing and 90% of Asia-to-Europe communications. Concurrently, 4 undersea backbones serve the Strait of Hormuz. A dual outage here would cut West-East communications entirely, with only 1 repair vessel active in the Gulf.

#### 3. Archaic International Law
The foundation of subsea cable law rests on an 1884 Convention. Technology giants are heavily lobbying Washington for active naval escort operations, shifting their defense posture from software firewalls to physical geopolitical deterrence.`,
    author: {
      nameAr: 'مكتب الترجمات الاستقصائية',
      nameEn: 'Translation Bureau',
      titleAr: 'ترجمات ودراسات الجغرافيا السياسية',
      titleEn: 'Geopolitical Research & Translations',
      avatar: 'https://images.unsplash.com/photo-1541872703-74c5e44368f9?auto=format&fit=crop&w=200&q=80'
    },
    ...
    isFeatured: true,
    isPremium: false,
    tags: ['الكابلات_البحرية', 'الذكاء_الاصطناعي', 'تشاتام_هاوس', 'الإيكونوميست', 'Subsea_Cables', 'AI_Boom', 'Chatham_House', 'Geopolitics'],
